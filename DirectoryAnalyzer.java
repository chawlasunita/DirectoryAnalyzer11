...
public class DirectoryAnalyzer {
    ...
    public static void main(String[] args) {
        String directoryPath = "C:\\Users\\Lenovo\\Desktop\\JavaProject11\\DirectoryAnalyzer";
    ...
    private static void createInputFile(String filename) {
        try (PrintWriter writer = new PrintWriter(filename)) {
            ...
            writer.println("honey,hn@example.com,8679034890");
            writer.println("leena,hcl@example.com,9890435624");
            writer.println("InvalidRecord"); // 
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
